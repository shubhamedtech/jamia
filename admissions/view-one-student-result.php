      ...
      <div class="d-flex align-items-center justify-content-between">
        ...
        <div>
          <?php if (in_array($_SESSION['Role'], ['Administrator', 'University Head'])) { ?>
            <button class="btn btn-link" aria-label="" title="" data-toggle="tooltip" data-original-title="Upload" onclick="upload('datesheets', 'md')"> <i class="fa fa-export fa-lg"></i></button>
          <?php } ?>
        </div>
      </div>
    </div>
