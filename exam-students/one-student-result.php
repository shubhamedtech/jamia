            ...
            var settings = {
                ...
                'columns': [{
                    ...
                    },
                    {
                        data: "Is_B2C",
                        "render": function(data, type, row) {
                            var type = data == 1 ? 'University is dealing<br>with Students.' : data == 2 ? 'University is dealing<br>with both Outsourced Partners and Students.' : 'University is dealing<br>with Outsourced Partners.';
                            return type;
                        }
                    },
                    {
                ...
                <i class="fa fa-edit icon-xs cursor-pointer" onclick="edit(&#39;universities&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="fa fa-trash icon-xs cursor-pointer" onclick="destroy(&#39;universities&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
                        }
                    },
                ],
