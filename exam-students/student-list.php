    ...
    <div class="content">
      <?php if (isset($_SESSION['university_id'])) { ?>
        <div class="card card-transparent">
          ...
          <div class="card-body">
            <div class="card card-transparent tab-style1">
              <!-- Nav tabs -->
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="active nav-link" data-toggle="tab" href="#applications"><span>All Applications - <span id="application_count">0</span></span></a>
                </li>
              </ul>
              <!-- Tab panes -->
