  ...
  <div class="content-wrapper">
    <!-- <div class="content-header sty-one">
      <div class="d-flex align-items-center justify-content-between">
        ...
        ?>
        <div>
          <button onclick="add('subjects', 'lg')" class="btn btn-link p-2" aria-label="" title="" data-toggle="tooltip" data-original-title="Add Subjects"> <i class="fa fa-plus-circle fa-lg"></i></button>
        </div>
      </div>
    </div> -->
          ...
          <div class="row pull-right">
            <div class="col-xs-7" style="margin-right: 10px;">
              ...
              <div class="col-xs-5" style="margin-right: 10px;">
                <button onclick="add('e-books', 'lg')" class="btn btn-primary p-2 " aria-label="" title="" data-toggle="tooltip" data-original-title="Add Subjects"> <i class="fa fa-plus-circle fa-lg"> Add</i></button>
              </div>
          </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var settings = {
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': '/lms-settings/e-book/data-list'
                },
                'columns': [{
                        data: "course_name"
                    },
            ...
            table.on('draw.dt', function() {
                ...
                $('.bs_switch').on('switchChange.bootstrapSwitch', function(event, state) {
                    ...
                    changeStatus('e_books', rowId,'status');
                });
            });
