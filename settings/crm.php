      ...
      { data: "ID",
        "render": function(data, type, row){
          return '<div class="text-end">\
            <i class="fa fa-edit icon-xs cursor-pointer" onclick="editComponents(\'stages\', \''+data+'\', \'md\');"></i>\
            <i class="fa fa-trash icon-xs cursor-pointer" onclick="destroyComponents(\'stages\', \'Stages\', \''+data+'\');"></i>\
          </div>'
        }
      },
    ],
  ...
  var table = $("#tableReasons").DataTable({
    ...
    'columns': [  
      ...
      { data: "ID",
        "render": function(data, type, row){
          return '<div class="text-end">\
            <i class="fa fa-edit icon-xs cursor-pointer" onclick="editComponents(\'reasons\', \''+data+'\', \'md\');"></i>\
            <i class="fa fa-trash icon-xs cursor-pointer" onclick="destroyComponents(\'reasons\', \'Reasons\', \''+data+'\');"></i>\
          </div>'
        }
      },
    ],
  ...
  var settings = {
    ...
    'columns': [  
      ...
      { data: "ID",
        "render": function(data, type, row){
          return '<div class="text-end">\
            <i class="fa fa-edit icon-xs cursor-pointer" onclick="editComponents(\'sources\', \''+data+'\', \'md\');"></i>\
            <i class="fa fa-trash icon-xs cursor-pointer" onclick="destroyComponents(\'sources\', \'Sources\', \''+data+'\');"></i>\
          </div>'
        }
      },
    ],
    ...
    'columns': [  
      ...
      { data: "ID",
        "render": function(data, type, row){
          return '<div class="text-end">\
            <i class="fa fa-edit icon-xs cursor-pointer" onclick="editComponents(\'reasons\', \''+data+'\', \'md\');"></i>\
            <i class="fa fa-trash icon-xs cursor-pointer" onclick="destroyComponents(\'reasons\', \'SubSources\', \''+data+'\');"></i>\
          </div>'
        }
      },
    ],
