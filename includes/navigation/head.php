        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview <?php print $breadcrumbs[1] == 'academics' ? 'open active' : '' ?>">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="/academics/universities"><i class="fa fa-angle-right"></i>Universities</a>
                    </li>
            ...
            <li class="<?php print $breadcrumbs[1] == 'settings' ? 'open active' : '' ?>">
                <a href="/settings/admission"><i class="icon-settings"></i> <span>Settings</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
            ...
            <?php if (isset($_SESSION['has_lms']) && $_SESSION['has_lms'] == 1) { ?>
                ...
                <li class="treeview <?php print $breadcrumbs[1] == 'lms-settings' ? 'open active' : '' ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="<?php print $breadcrumbs[2] == 'results' ? 'open active' : '' ?>">
                            <a href="/lms-settings/results"><i class="fa fa-angle-right"></i>Results</a>
                        </li>
