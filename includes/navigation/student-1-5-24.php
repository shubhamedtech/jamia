...
<aside class="main-sidebar">
    <div class="sidebar">
        <ul class="sidebar-menu" data-widget="tree">
            ...
            ?>
                <li class="treeview <?php print array_key_exists(2, $breadcrumbs) && $breadcrumbs[2] == 'lms' ? 'open active' : '' ?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <?php if (in_array('E-Books', $_SESSION['LMS_Permissions'])) { ?>
                            <li>
                                <a href="/student/lms/e-books"><i class="fa fa-angle-right"></i>E-Books</a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if (in_array('Videos', $_SESSION['LMS_Permissions'])) { ?>
                            <li class="<?php print $breadcrumbs[3] == 'videos' ? 'open active' : '' ?>">
                                <a href="/student/lms/videos"><i class="fa fa-angle-right"></i>Videos</a>
                            </li>
                        <?php } ?>
                        <?php if (in_array('Videos', $_SESSION['LMS_Permissions'])) { ?>
                            <li class="<?php print $breadcrumbs[3] == 'e-books' ? 'open active' : '' ?>">
                                <a href="/student/lms/e-books"><i class="fa fa-angle-right"></i>E-Books</a>
                            </li>
                        <?php } ?>
                    </ul>
