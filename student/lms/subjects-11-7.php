    ...
    <div class="content-wrapper">
        ...
        if (isset($_GET['id'])) {
            ...
            if (isset($_GET['languagetype'])) {
                ...
                // $languagetypeSql = "AND video_lectures.Languages_Categories =''";
            }
            if (isset($_GET['lectureType'])) {
                $lectureTypeSql = " AND video_lectures.Videos_Categories = " . $_GET['lectureType'];
            } else {
                // $lectureTypeSql = " AND video_lectures.Videos_Categories =''";
            }
        } else {
            $active = "active";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" id="lectureType">
                                            <option>Choose Lecture Type</option>
                                        ...
                                        <select class="form-control" id="languagetype">
                                            ...
                                            ?>
                                            <option>Choose Languages Types</option>
