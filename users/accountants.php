    ...
    <div class="content-wrapper">
        <div class="content-header sty-one">
            <div class="d-flex align-items-center justify-content-between">
                ...
                ?>
                <div>
                    <button class="btn btn-link p-2" aria-label="" title="" data-toggle="tooltip" data-original-title="Download" le="tooltip" data-original-title="Add" onclick="add('accountants','lg')"> <i class="fa fa-plus-circle fa-lg"></i></button>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var settings = {
                ...
                <i class="fa fa-plus-circle text-success icon-xs cursor-pointer" title="Allot Boards" onclick="allot(&#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="fa fa-edit icon-xs text-warning cursor-pointer" title="Edit" onclick="edit(&#39;accountants&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="fa fa-trash icon-xs text-danger cursor-pointer" title="Delete" onclick="destroy(&#39;accountants&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
                        }
                    },
                ],
