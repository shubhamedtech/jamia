  ...
  <div class="content-wrapper">
    <div class="content-header sty-one">
      <div class="d-flex justify-content-between">
        ...
        ?>
        <button class="btn btn-link" aria-label="Add Operation's User" data-toggle="tooltip" data-placement="top" title="Add Operation's User" onclick="add('university-heads','lg')"><i class=" fa fa-plus-circle fa-lg"></i></button>
      </div>
    </div>
          ...
          },
          {
            ...
            "render": function(data, type, row) {
              return '<div class="button-list text-end">\
                ...
                <i class="fa fa-edit icon-xs text-warning cursor-pointer" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;university-heads&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="fa fa-trash icon-xs text-danger cursor-pointer" data-toggle="tooltip" data-placement="top" title="Delete" onclick="destroy(&#39;university-heads&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
            }
          },
        ],
