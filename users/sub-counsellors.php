        ...
        <div class="content-header sty-one">
            <div class="d-flex justify-content-between">
                ...
                <div class="text-end">
                    ...
                    <button class="btn btn-link p-2" aria-label="" title="" data-toggle="tooltip" data-original-title="Add" onclick="add('sub-counsellors','lg')"> <i class="fa fa-plus-circle fa-lg"></i></button>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var settings = {
                ...
                <i class="fa fa-plus-circle text-success icon-xs cursor-pointer" data-toggle="tooltip" data-placement="top" title="Allot Board" onclick="allot(&#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="fa fa-edit text-warning icon-xs cursor-pointer" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;sub-counsellors&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="fa fa-trash text-danger icon-xs cursor-pointer" data-toggle="tooltip" data-placement="top" title="Delete" onclick="destroy(&#39;sub-counsellors&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
                        }
                    },
                ],
