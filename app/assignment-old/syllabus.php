          ...
          <?php while ($row = $syllabus->fetch_assoc()) { ?>
            <tr>
              ...
              <td>
                ...
                <?php if (in_array($_SESSION['Role'], ['Administrator', 'University Head', 'Academic'])) { ?><button class="btn btn-link" onclick="uploadFile('Syllabi', 'Assignment', <?= $row['ID'] ?>)">Upload</button><?php } ?>
              </td>
            </tr>
          <?php } ?>
        </tbody>
