...
session_start();
if ($_SESSION['university_name'] == "GKU (Manegment)") { ?>
    ...
    <div class="modal-body">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group form-group-default required">
            ...
            <select class="form-control" id="university_id" name="university_id" onchange="getDetails(this.value);">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group form-group-default required">
            <label>Mode</label>
            <select class="form-control" id="mode" name="mode" onchange="getFeeSructures()">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group form-group-default form-group-default-select2 required">
            <label>Academic Eligibility</label>
            <select class="form-control" style="width: 100% !important;" data-init-plugin="select2" id="eligibilities" name="eligibilities[]" multiple>
      ...
      <div class="col-md-4">
        <div class="form-group form-group-default required">
          <label>Lateral</label>
          <select class="form-control" id="lateral" name="lateral">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group form-group-default required">
          ...
          <select class="form-control" id="ct_transfer" name="ct_transfer">
            <option value="0">No</option>
            <option value="1">Yes</option>
          </select>
        </div>
    ...
    <div class="modal-body">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group form-group-default form-group-default-select2 required">
            <label>Academic Eligibility</label>
              <select class="form-control js-example-basic-multiple" style="width: 100% !important;" data-init-plugin="select2" id="eligibilities" name="eligibilities[]" multiple>
                <?php foreach ($eligibilities as $eligibility) { ?>
                  <option value="<?= $eligibility ?>"><?= $eligibility ?></option>
                <?php } ?>
              </select>
