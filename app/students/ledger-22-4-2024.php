      ...
      <div class="col-md-3">
        ...
        <div class="py-3 text-center">
          ...
          <?php if (in_array($_SESSION['Role'], ['Administrator', 'Accountant'])) { ?>
            <button class="btn btn-primary btn-sm" onclick="add('offline-payments', 'lg')">Pay Offline</button>
          <?php } ?>
        </div>
      </div>
      <div class="col-md-9">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-right"><?php $balance = $ledger['Fee'];
                                              echo $debit = $ledger['Type'] == 1 ? $balance : 0; ?>
                      </td>
                    </tr>
                  <?php } ?>
                  </tr>
