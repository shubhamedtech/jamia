            ...
            <div class="row">
              <div class="col-md-12 d-flex justify-content-start">
                ...
                <?php if ( $_SESSION['Role'] != 'Sub-Center' || $_SESSION['Role'] != 'Center') { ?>
                  ...
                  <?php } ?>
                  <?php if ($_SESSION['Role'] == 'Administrator' || $_SESSION['Role'] == 'Sub-Center' || $_SESSION['Role'] == 'Center') { ?>
                  <div class="col-md-2 m-b-10">
                    <div class="form-group">
                      <select class="form-control"  data-init-plugin="select2" id="sub_center" onchange="addSubCenterFilter(this.value, 'users')" data-placeholder="Choose Sub Center">
