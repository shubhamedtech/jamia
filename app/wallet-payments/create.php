  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="form-group form-group-default required">
        ...
        <select class="form-control" onchange="checkPaymentMode(this.value)" name="payment_mode" required>
          <option value="">Select</option>
          <option value="Offline">Offline</option>
          <?php if (isset($_SESSION['access_key'])) { ?>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group form-group-default required">
            ...
            <select class="form-control" onchange="checkFileIsRequred(this.value)" name="payment_type" required>
              <option value="">Select</option>
    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-md-12">
          <div class="form-group form-group-default required">
            <label>Amount</label>
            <input type="number" min="1" name="online_amount" id="online_amount" class="form-control" placeholder="ex: 50000" required>
          </div>
        </div>
      </div>
    </div>
