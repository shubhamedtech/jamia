    ...
    <div class="modal-body">
      ...
      <div class="row session_row">
        <div class="col-md-3">
          <div class="form-group form-group-default required">
            <label>Session</label>
            <select class="form-control" name="session[1]">
        ...
        <div class="col-md-4">
          <div class="form-group form-group-default required">
            ...
            <select class="form-control" name="admission_type[1]">
              <option value="">Choose</option>
              <?php
        ...
        <div class="col-md-2 text-center p-t-15">
          <i class="fa fa-plus-square" onclick="appendDiv()"></i>
        </div>
      </div>
    </div>
    ...
    function appendDiv(){
      ...
      var div = '<div class="row session_row" id="session_row_'+uniqid+'">\
        <div class="col-md-3">\
          <div class="form-group form-group-default required">\
            <label>Session</label>\
            <select class="form-control" name="session['+uniqid+']" required>\
              <option value="">Choose</option>\
        ...
        <div class="col-md-4">\
          <div class="form-group form-group-default required">\
            <label>Admission Type</label>\
            <select class="form-control" name="admission_type['+uniqid+']">\
              <option value="">Choose</option>\
        ...
        <div class="col-md-2 text-center p-t-15">\
          <i class="fa fa-minus-square" onclick="removeDiv('+uniqid+')"></i>\
        </div>\
      </div>';
