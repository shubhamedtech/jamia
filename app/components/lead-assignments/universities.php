      ...
      <div class="col-md-12 mb-2"></div>
        ...
        <div class="col-md-4 pb-2">
          <div class="form-group form-group-default form-group-default-select2">
            ...
            <select class="form-control" data-init-plugin="select2" multiple id="source_<?=$university['ID']?>" name="sources[<?=$university['ID']?>][]" onchange="getSubSources('<?=$university['ID']?>')">
        ...
        <div class="col-md-4 pb-2">
          <div class="form-group form-group-default form-group-default-select2">
            ...
            <select class="form-control" data-init-plugin="select2" multiple id="sub_source_<?=$university['ID']?>" name="sub_sources[<?=$university['ID']?>][]">
              <option value="All">All</option>
        ...
        <div class="col-md-4 pb-2">
          <div class="form-group form-group-default form-group-default-select2">
            ...
            <select class="form-control" data-init-plugin="select2" multiple id="country_<?=$university['ID']?>" name="countries[<?=$university['ID']?>][]" onchange="getStates('<?=$university['ID']?>')">
              <option value="All">All</option>
              <?php 
        ...
        <div class="col-md-4 pb-2">
          <div class="form-group form-group-default form-group-default-select2">
            <label>State(s)</label>
            <select class="form-control" data-init-plugin="select2" multiple id="state_<?=$university['ID']?>" name="states[<?=$university['ID']?>][]" onchange="getCities('<?=$university['ID']?>')">
              <option value="All">All</option>
        ...
        <div class="col-md-4 pb-2">
          <div class="form-group form-group-default form-group-default-select2">
            ...
            <select class="form-control" data-init-plugin="select2" multiple id="city_<?=$university['ID']?>" name="city[<?=$university['ID']?>][]">
              <option value="All">All</option>
        ...
        <div class="col-md-4 pb-2">
          <div class="form-group form-group-default form-group-default-select2">
            <label>Role(s)</label>
            <select class="form-control" data-init-plugin="select2" multiple id="user_role_<?=$university['ID']?>" name="user_roles[<?=$university['ID']?>][]" onchange="getUsers('<?=$university['ID']?>');">
              <option value="All">All</option>
        ...
        <div class="col-md-4 pb-2">
          <div class="form-group form-group-default form-group-default-select2">
            <label>User(s)</label>
            <select class="form-control" data-init-plugin="select2" multiple id="user_<?=$university['ID']?>" name="users[<?=$university['ID']?>][]">
              <option value="All">All</option>
