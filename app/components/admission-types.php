      ...
      { data: "ID",
        "render": function(data, type, row){
          return '<div class="text-end">\
            <i class="fa fa-edit text-warning icon-xs cursor-pointer" onclick="editComponents(\'admission-types\', \''+data+'\', \'md\');"></i>\
            <i class="fa fa-trash text-danger icon-xs cursor-pointer" onclick="destroyComponents(\'admission-types\', \'AdmissionType\', \''+data+'\');"></i>\
          </div>'
        }
      },
    ],
