...
<script type="text/javascript">
      ...
      },
      {
        ...
        "render": function(data, type, row) {
          return '<div class="text-end">\
            <i class="fa text-warning fa-edit icon-xs cursor-pointer" onclick="editComponents(\'modes\', \'' + data + '\', \'md\');"></i>\
            <i class="fa text-danger fa-trash icon-xs cursor-pointer" onclick="destroyComponents(\'modes\', \'Modes\', \'' + data + '\');"></i>\
          </div>'
        }
      },
    ],
  ...
  table.on('draw.dt', function() {
    ...
    $('.bs_switch').on('switchChange.bootstrapSwitch', function(event, state) {
      ...
      changeComponentStatus('Modes','Modes', rowId);
    });
  });
</script>