...
<form role="form" id="form-upload" foemtarget="_blank" action="/app/videos/assessments/store" method="POST" enctype="multipart/form-data">
  <div class="modal-body">

    <div class="row">
      <div class="col-md-12 text-end cursor-pointer" onclick="window.open('/app/samples/assessments');">
        <i class="fa fa-file-download-alt"></i><u><span class="text-primary ml-1">Sample</span></u>
      </div>
    </div>
    <?php
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <input name="video_id" type="hidden" value="<?= $video_id ?>" id="video_id" />
        <input name="file" type="file" accept="application/csv" requireed/>
      </div>
    </div>
  </div>
