...
<div class="modal-body">
    ...
    <form id="editassignmentform" method="post" action="/app/assignments/teacher-update-assignment.php" enctype="multipart/form-data">
        <input type="hidden" name="id" id="id" value="<?= htmlspecialchars($assignment['id']) ?>">
        <div class="row">
            <!-- Course Type -->
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="subject_id" name="subject" required>
                        ...
                        if (isset($assignment['course_id'])) {
                            ...
                            $subject_sql = "SELECT ID, Name FROM Subjects WHERE Program_Grade_ID = ?";
                            $subject_stmt = $conn->prepare($subject_sql);
                            $subject_stmt->bind_param("i", $course_id);
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="assignmentname" value="<?= htmlspecialchars($assignment['assignment_name']) ?>" placeholder="Assignment Name" required name="assignmentname">
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="marks" value="<?= intval($assignment['marks']) ?>" placeholder="Marks" required name="marks">
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="files" name="files" accept=".pdf, .jpeg, .jpg, .png, .gif">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="startdate" value="<?= htmlspecialchars($assignment['start_date']) ?>" required name="startdate">
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="enddate" value="<?= htmlspecialchars($assignment['end_date']) ?>" required name="enddate">
                </div>
            </div>
        </div>
