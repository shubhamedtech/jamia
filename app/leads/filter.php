  ...
  <div class="modal-body">
    <div class="row filter-options pb-2" id="filter_options_1">
      ...
      <div class="col-md-1 text-center pt-1">
        <i class="fa fa-minus-square-full cursor-pointer" onclick="removeFilter(1)" style="margin-right:10px; font-size:18px;"></i><i class="fa fa-plus-square cursor-pointer" style="font-size:18px;" onclick="addMoreFilter()"></i>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  function addMoreFilter(){
    ...
    <div class="col-md-1 text-center pt-1">\
      <i class="fa fa-minus-square-full cursor-pointer" onclick="removeFilter('+filter_id+')" style="margin-right:10px; font-size:18px;"></i><i class="fa fa-plus-square cursor-pointer" style="font-size:18px;" onclick="addMoreFilter()"></i>\
    </div>\
  </div>');
  }
