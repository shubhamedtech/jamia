  ...
  <div class="modal-body">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group form-group-default required">
          ...
          <select class="form-control" name="university_id" id="university_id" onchange="getDepartmentDetails(this.value)">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="form-group form-group-default required">
          <label>Stage</label>
          <select class="form-control" name="stage" id="stage" onchange="getReasons(this.value)" required>
            <option value="">Choose</option>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="form-group form-group-default required">
          <label>Source</label>
          <select class="form-control" name="source" id="source" onchange="getSubSources(this.value)" required>
            <option value="">Choose</option>
