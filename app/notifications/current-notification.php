...
<div class="modal-header clearfix text-left">
    ...
    <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="change_notification_status()"><span aria-hidden="true">&times;</span></button>
</div>
        ...
        <div class="p-2">
            ...
            if (isset($_GET['id'])) {
                ...
                while ($row = $result_record->fetch_assoc()) { ?>
                    <span class="mr-1"><?= $row['Heading'] ?>:</span>
