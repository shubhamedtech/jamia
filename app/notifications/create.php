  ...
  <div class="modal-body">
    <div class="row">
      <div class="col-md-4">
        <div class="form-group form-group-default required">
          <label>Send to</label>
          <select class="form-control" id="send_to" name="send_to" onchange="removeTable()">
      ...
      <div class="col-md-4">
        <div class="form-group form-group-default required">
          ...
          <select class="form-control" id="heading" name="heading" onchange="removeTable()">
            <option value="">Choose</option>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group form-group-default required">
          <label>Content</label>
          <textarea type="content" name="content" class="form-control" rows="5" cols="50" required></textarea>
        </div>
      </div>
    </div>
