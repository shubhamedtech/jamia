...
if (isset($_POST['inserted_id'])) {
  ...
  $district = mysqli_real_escape_string($conn, isset($_POST['district']) ? $_POST['district'] : '');
  $district = strtoupper(strtolower($district));
  $state = mysqli_real_escape_string($conn, $_POST['state']);
  $state = strtoupper(strtolower($state));

  $postal_code = mysqli_real_escape_string($conn, $_POST['postal_code']);
  $internatiol_city = mysqli_real_escape_string($conn, $_POST['internatiol_city']);
  ...
  $update = $conn->query("UPDATE Students SET Email = '$email', Alternate_Email = '$alternate_email', Contact = '$contact', Alternate_Contact = '$alternate_contact', Address = '$address', Postal_Code = '$postal_code', Internatiol_City = '$internatiol_city' $step_query WHERE ID = $inserted_id");
