...
?>
  ...
  <div class="modal-header clearfix text-left">
    ...
    <button aria-label="" type="button" class="close" onclick="hideReportModal()" aria-hidden="true"><i class="ti-close"></i>
    </button>
  </div>
  ...
  <script>
    ...
    function addRemark(id) {
      var input = '<div class="form-group form-group-default required">\
              <label>Remark</label>\
              <input type="text" class="form-control" id="remark_for_' + id + '" autocomplete="off" name="remark[' + id + ']" placeholder="Remark for ' + id.replace(/_/g, ' ') + '" required />\
            </div>';
