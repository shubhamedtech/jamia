...
<form role="form" id="form-add-question-banks" action="/app/question-banks/store" method="POST" enctype="multipart/form-data">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="form-group form-group-default required">
					...
					<input type="text" name="title" class="form-control" placeholder="Enter Question-Bank  Name..." required>
				</div>
			</div>
			<div class="col-md-12">
				<label>Question-Bank file *</label>
...
<script>
	...
	$(function() {
		$('#form-add-question-banks').validate({
			rules: {
				course_id: {
					required: true
				},
	...
	$('#form-add-question-banks').submit(function(e) {
		if ($('#form-add-question-banks').valid()) {
			...
			$.ajax({
				...
				success: function(data) {
					...
					$('#question-banks-table').DataTable().ajax.reload(null, false);
				},
				error: function(data) {
